...
import org.example.Common.ArtisanProduct;
import org.example.Common.BasicItem;
...
public enum ArtisanType {
    ...
    FishSmoker(List.of(Map.of(Map.of("Coal", 1, "Salmon", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Salmon.getPrice())),
        Map.of(Map.of("Coal", 1, "Sardine", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Sardine.getPrice())),
        Map.of(Map.of("Coal", 1, "Shad", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Shad.getPrice())),
        Map.of(Map.of("Coal", 1, "Blue Discus", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.BlueDiscus.getPrice())),
        Map.of(Map.of("Coal", 1, "Midnight Carp", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.MidnightCarp.getPrice())),
        Map.of(Map.of("Coal", 1, "Squid", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Squid.getPrice())),
        Map.of(Map.of("Coal", 1, "Tuna", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Tuna.getPrice())),
        Map.of(Map.of("Coal", 1, "Perch", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Perch.getPrice())),
        Map.of(Map.of("Coal", 1, "Flounder", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Flounder.getPrice())),
        Map.of(Map.of("Coal", 1, "Lion Fish", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Lionfish.getPrice())),
        Map.of(Map.of("Coal", 1, "Herring", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Herring.getPrice())),
        Map.of(Map.of("Coal", 1, "Ghost Fish", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.GhostFish.getPrice())),
        Map.of(Map.of("Coal", 1, "Tilapia", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Tilapia.getPrice())),
        Map.of(Map.of("Coal", 1, "Dorado", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Dorado.getPrice())),
        Map.of(Map.of("Coal", 1, "Sun Fish", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Sunfish.getPrice())),
        Map.of(Map.of("Coal", 1, "Rainbow Trout", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.RainbowTrout.getPrice())),
        Map.of(Map.of("Coal", 1, "Legend", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Legend.getPrice())),
        Map.of(Map.of("Coal", 1, "Glacier Fish", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.GlacierFish.getPrice())),
        Map.of(Map.of("Coal", 1, "Angler", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.Angler.getPrice())),
        Map.of(Map.of("Coal", 1, "Crimson Fish", 1), new ArtisanProduct("Smoked Fish", 150, 1, 2 * FishType.CrimsonFish.getPrice())))),
    ...
    public void useArtisan(List<String> inputItems, ArtisanMachine machine) {
        ...
        for (Map<Map<String, Integer>, ArtisanProduct> recipes : items) {
            ...
            // Sort by longest ingredient name first
            ...
            for (Map.Entry<Map<String, Integer>, ArtisanProduct> entry : sortedEntries) {
                Map<String, Integer> requiredIngredients = entry.getKey();
...
//                        .count();
                    ...
                    for (int i = 0; i < requiredAmount; i++) {
                        inputCopy.remove(ingredientName);
                    }
                }

                if (matches && inputCopy.isEmpty()) {
                    System.out.println(product.getName() + " will be ready in " + product.getProcessingTime() + " hours");
                    machine.setProduct(new ArtisanProduct(product.getName(), product.getEnergy(), product.getProcessingTime(), product.getPrice()));
                    return;
                } else if (matches) {
                    System.out.println("Extra items in input: " + inputCopy);
                    return;
                }
            }

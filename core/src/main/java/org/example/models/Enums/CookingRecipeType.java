...
public enum CookingRecipeType implements Material, Item {
    ...
    BakedFish("Baked Fish", () -> Map.of(FishType.Sardine, 1, FishType.Salmon, 1, CropType.Wheat, 1), 75, false, "Starter", 100,"Stardew_Valley_Images-main/Recipe/Baked_Fish.png"),
    ...
    MakiRoll("Maki Roll", () -> Map.of(FishType.Sardine, 1, MyGame.getDatabase().getItem("Rice"), 1, MyGame.getDatabase().getItem("Fiber"), 1), 100, false, "Stardrop Saloon", 220,"Stardew_Valley_Images-main/Recipe/Maki_Roll.png"),
    ...
    DishOTheSea("Dish O' the Sea", () -> Map.of(FishType.Sardine, 2, CropType.HotPepper, 1), 150, true, "Fishing level 2", 220,"Stardew_Valley_Images-main/Recipe/Dish_O%27_The_Sea.png"),
    SeaformPudding("Seaform Pudding", () -> Map.of(FishType.Flounder, 1, FishType.MidnightCarp, 1), 175, true, "Fishing level 3", 300,"Stardew_Valley_Images-main/Recipe/Seafoam_Pudding.png"),

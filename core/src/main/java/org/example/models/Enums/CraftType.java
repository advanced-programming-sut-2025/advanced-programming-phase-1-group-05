...
public enum CraftType implements Material, Item {
    ...
    CheesePress("Cheese Press", () -> Map.of(Game.getDatabase().getItem("Wood"), 45, MineralType.Copper, 1), "Farming Level 2", 0),
    Keg("Keg", () -> Map.of(Game.getDatabase().getItem("Wood"), 30, MineralType.Iron, 1, MineralType.Copper, 1), "Farming Level 3", 0),
